## 3.1 - Joys of JavaScript (6:30 PM) <!--links--> &nbsp; [⬅️](../../02-Week/03-Day/03-Day-LessonPlan.md) &nbsp; [➡️](../02-Day/02-Day-LessonPlan.md)

### Slideshow

* This lesson's slides are available on Google Drive here: [03-1 The Joys of JavaScript](https://docs.google.com/presentation/d/1tOrt3mlFmdVdCYGanaGoYfqw3ciJp9Z7AS8t8fy3RKg/edit?usp=sharing)
...
### 1. Everyone Do: Welcome Students (1 mins)

* Welcome students and see how they are doing while opening up the slide deck [03-1 The Joys of JavaScript](https://docs.google.com/presentation/d/1tOrt3mlFmdVdCYGanaGoYfqw3ciJp9Z7AS8t8fy3RKg/edit?usp=sharing).
...
### 4. Students Do: Code Dissection (7 mins)
...
* Then Slack out the following file and instructions to students:
  ...
  * **Instructions**
    ...
    * Think about how the code connects to the events that happen on the page.
...
* Slack out the following files and instructions:
  ...
  * **Instructions**
    ...
    * Think about the difference between using `console.log` and `alert`. Prepare an answer as you might be called on!
...
### 16. Groups Do: Alert Activity (15 min)
...
### 21. Groups Do: If/Else Activity #1 (15 mins)
...
[Went Well](http://www.surveygizmo.com/s3/4325914/FS-Curriculum-Feedback?format=lo&sentiment=positive&lesson=03.01)

[Went Poorly](http://www.surveygizmo.com/s3/4325914/FS-Curriculum-Feedback?format=lo&sentiment=negative&lesson=03.01)
